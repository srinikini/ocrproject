...
for k in range(1,37):
    for l in range(1,1701):
        path=r'C:/Users/Naman/Desktop/DevanagariHandwrittenCharacterDataset/Train1/character (%d)/(%d).png'%(k,l);
...
for k in range(1,37):
    for l in range(1,301):
        path=r'C:/Users/Naman/Desktop/DevanagariHandwrittenCharacterDataset/Test1/character (%d)/(%d).png'%(k,l);
        im=mimage.imread(path)
        for i in range(0,30,2):
            for j in range(0,30,2):
...
filename=r'C:\Users\Naman\Desktop\DevanagariHandwrittenCharacterDataset\First programs\hindialphabetsclass.pkl';
